Code de test implémentant un CredentialProvider Windows en vue notamment d'une authentification se basant sur la carte (uniquement ou en tant que second facteur pour du MFA).
...
* À noter : Windows exige des credentials complets en une fois ; un CredentialProvider ne peut pas "suspendre" l'authentification pour attendre un badge ou autre
...
* À voir si cela présente un rél intérêt/usage...
